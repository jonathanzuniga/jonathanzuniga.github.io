(function (root, factory) {
	...
	IFCDate.prototype.setDaysList = function (value) {
		var presets = {
			...
			'iso-8601-es': ['lunes', 'martes', 'miércoles', 'jueves', 'viernes', 'sábado', 'domingo', 'día anual', 'día bisiesto']
		};
	...
	IFCDate.prototype.setMonthsList = function (value) {
		var presets = {
			...
			cotsworth_es        : ["enero", "febrero", "marzo", "abril", "mayo", "junio", "sol", "julio", "agosto", "septiembre", "octubre", "noviembre", "diciembre"]
		};
	...
	*/
	...
	IFCDate.prototype.toDateString = function () {
		...
		return IFCDate + '.º de ' + months[IFCMonth] + ' de ' + year;
